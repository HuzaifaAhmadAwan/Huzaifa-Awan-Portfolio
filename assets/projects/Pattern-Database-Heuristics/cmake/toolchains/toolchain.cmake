...
if (${CMAKE_HOST_SYSTEM_NAME} MATCHES "Darwin")
    if (EXISTS "/usr/local/opt/llvm@20/bin/clang++")
        ...
        set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -L/usr/local/opt/llvm@20/lib/c++ -Wl,-rpath,/usr/local/opt/llvm@20/lib/c++")
    elseif(EXISTS "/opt/homebrew/opt/llvm@20/bin/clang++")
        set(CMAKE_CXX_COMPILER "/opt/homebrew/opt/llvm@20/bin/clang++")
        set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -L/opt/homebrew/opt/llvm@20/lib/c++ -Wl,-rpath,/opt/homebrew/opt/llvm@20/lib/c++")
