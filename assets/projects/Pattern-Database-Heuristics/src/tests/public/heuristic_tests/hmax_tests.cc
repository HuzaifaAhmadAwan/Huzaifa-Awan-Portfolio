...
TEST(HMaxTestsPublic, test_bw_goal_aware)
{
    // 4 blocks
    ...
    auto hmax = create_hmax_heuristic(task);

    ASSERT_EQ(get_initial_state_estimate(*task, *hmax), 0);
}

TEST(HMaxTestsPublic, test_bw_single_state)
{
    // 4 blocks
    BlocksWorld domain(4);
...
TEST(HMaxTestsPublic, test_bw_single_state_reeval)
{
    // 4 blocks
    BlocksWorld domain(4);
...
TEST(HMaxTestsPublic, test_bw_astar)
{
    // 4 blocks
    ...
    auto task = tests::create_task_from_domain(domain, initial_state, goal);
    std::shared_ptr hmax = create_hmax_heuristic(task);
    auto engine = create_astar_search_engine(task, hmax);

    engine->search();

    ASSERT_TRUE(engine->found_solution());
    ASSERT_EQ(engine->get_statistics().get_reopened(), 0);
    ASSERT_EQ(engine->get_statistics().get_expanded(), 3007);
...
TEST(HMaxTestsPublic, test_gripper_goal_aware)
{
    // 2 rooms, 2 balls
    Gripper domain(2, 2);
...
TEST(HMaxTestsPublic, test_gripper_single_state)
{
    // 2 rooms, 2 balls
    Gripper domain(2, 2);
...
TEST(HMaxTestsPublic, test_gripper_single_state_reeval)
{
    // 2 rooms, 2 balls
    Gripper domain(2, 2);
...
TEST(HMaxTestsPublic, test_gripper_astar)
{
    // 2 rooms, 2 balls
    Gripper domain(2, 2);
    ...
    ASSERT_TRUE(engine->found_solution());
    ASSERT_EQ(engine->get_statistics().get_reopened(), 0);
    ASSERT_EQ(engine->get_statistics().get_expanded(), 12);
...
TEST(HMaxTestsPublic, test_visitall_goal_aware)
{
    // 2 rooms, 2 balls
    VisitAll domain(2, 2);
...
TEST(HMaxTestsPublic, test_visitall_single_state)
{
    // 2 rooms, 2 balls
    VisitAll domain(2, 2);
...
TEST(HMaxTestsPublic, test_visitall_single_state_reeval)
{
    // 2 rooms, 2 balls
    VisitAll domain(2, 2);
...
TEST(HMaxTestsPublic, test_visitall_astar)
{
    // 2 rooms, 2 balls
    VisitAll domain(2, 2);
...
TEST(HMaxTestsPublic, test_sokoban_goal_aware)
{
...
TEST(HMaxTestsPublic, test_sokoban_dead_end)
{
    const SokobanGrid playarea = {
        {' ', ' ', ' '},
        {' ', ' ', ' '},
...
TEST(HMaxTestsPublic, test_sokoban_single_state)
{
    const SokobanGrid playarea = {
        {' ', 'G', 'G'},
        {' ', ' ', ' '},
...
TEST(HMaxTestsPublic, test_sokoban_single_state_reeval)
{
    const SokobanGrid playarea = {
        {' ', 'G', 'G'},
        {' ', ' ', ' '},
...
TEST(HMaxTestsPublic, test_sokoban_astar)
{
    const SokobanGrid playarea = {
        {' ', ' ', ' '},
        {' ', ' ', 'G'},
    ...
    ASSERT_TRUE(engine->found_solution());
    ASSERT_EQ(engine->get_statistics().get_reopened(), 0);
    ASSERT_EQ(engine->get_statistics().get_expanded(), 6);
...
TEST(HMaxTestsPublic, test_nomystery_goal_aware)
{
    // 0 -- 1 -- 2 -- 3
...
TEST(HMaxTestsPublic, test_nomystery_dead_end)
{
...
TEST(HMaxTestsPublic, test_nomystery_single_state)
{
    // 4 -- 5 -- 6
    // |  /
    // | /
...
TEST(HMaxTestsPublic, test_nomystery_single_state_reeval)
{
    // 4 -- 5 -- 6
    // |  /
    // | /
...
TEST(HMaxTestsPublic, test_nomystery_astar)
{
    // 4 -- 5 -- 6
    // |  /    /
    // | /    /
    ...
    ASSERT_TRUE(engine->found_solution());
    ASSERT_EQ(engine->get_statistics().get_reopened(), 0);
    ASSERT_EQ(engine->get_statistics().get_expanded(), 156);
