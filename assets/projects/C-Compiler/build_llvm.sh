...
#       from the binaries.
# "-DLLVM_TARGETS_TO_BUILD="host"" restricts the LLVM build to only create
#       backend code for the host CPU (e.g. X86 for Intel/AMD, AArch64 for Apple, ..).
#       As backends tend to be huge, this improves build times and memory
#       as well as disk space consumption.
